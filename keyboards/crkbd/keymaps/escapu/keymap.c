...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+------------+------------+------------+------------+--------------|                    |--------+------------+------------+------------+---------------+---------|
        MO(4),        KC_Z,        KC_X,        KC_C,        KC_V,          KC_B,                         KC_N,        KC_M,     KC_COMM,      KC_DOT,        KC_SLSH,   KC_EQL,
  //|--------+------------+------------+------------+------------+--------------+--------|  |--------+--------+------------+------------+------------+---------------+---------|
                                                            MO(1), SFT_T(KC_SPC), KC_BSPC,     KC_ENT, KC_SPACE,   MO(2)
                                                      //`--------------------------------'  `--------------------------'
  ...
  //|--------+-----------+-----------+-----------+-----------+--------|                          |----------+-----------+---------+-----------+------------+--------|
       KC_ENT,    C(KC_Z),    C(KC_X),    C(KC_C),    C(KC_P), KC_WH_D,                           KC_MS_BTN1, KC_MS_LEFT, KC_MS_UP, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_BTN2,
  //|--------+-----------+-----------+-----------+-----------+--------+--------------|  |--------+----------+-----------+---------+-----------+------------+--------|
                                                      _______, SFT_T(KC_ENT), KC_DEL,     KC_ENT, KC_SPACE,   MO(3)
                                                  //`--------------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_GRV, KC_BSLS, KC_LBRC, KC_RBRC, KC_NUBS, KC_NUHS,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       KC_ENT, C(KC_Z), C(KC_X), C(KC_C), C(KC_P), XXXXXXX,                      KC_TILD, KC_PIPE, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                            MO(3), KC_LSFT,  KC_DEL,     KC_ENT, KC_SPACE, _______
                                      //`--------------------------'  `--------------------------'
  ),
...
static void render_status(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case 1:
            ...
            oled_write_P(PSTR("  1\n"), false);
            oled_write_P(PSTR("  1\n"), false);
            oled_write_P(PSTR("11111"), false);
            break;
        case 2:
            oled_write_P(PSTR(" 222\n"), false);
            oled_write_P(PSTR("2   2"), false);
            oled_write_P(PSTR("   2\n"), false);
            oled_write_P(PSTR("  2\n"), false);
            oled_write_P(PSTR(" 2\n"), false);
            oled_write_P(PSTR("22222"), false);
            break;
        case 3:
            oled_write_P(PSTR("3333\n"), false);
            oled_write_P(PSTR("    3"), false);
            oled_write_P(PSTR("  33\n"), false);
            oled_write_P(PSTR("    3"), false);
            oled_write_P(PSTR("3   3"), false);
            oled_write_P(PSTR(" 333\n"), false);
            break;
        case 4:
            oled_write_P(PSTR("   4\n"), false);
            oled_write_P(PSTR("  44\n"), false);
            oled_write_P(PSTR(" 4 4\n"), false);
            oled_write_P(PSTR("44444"), false);
            oled_write_P(PSTR("   4\n"), false);
            oled_write_P(PSTR("   4\n"), false);
            break;
        default:
